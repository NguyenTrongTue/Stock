<template>
  <Close v-if="type == 'Close'" />
  <Increase v-if="type == 'Increase'" />
  <Decrease v-if="type == 'Decrease'" />
  <Eye v-if="type == 'Eye'" />
  <HideEye v-if="type == 'HideEye'" />
  <ArrowLeft v-if="type == 'ArrowLeft'" />
  <Logo v-if="type == 'Logo'" />
...
import HideEye from "./HideEye.vue";
